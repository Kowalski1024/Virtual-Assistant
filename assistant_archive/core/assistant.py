...
from assistant_archive.response import Response, ResponseType
...
class Assistant:
    ...
    def run(self) -> None:
        """
        Head function to run the assistant_archive, starts all necessary threads and enters an infinite loop to manage the gui
        """
    ...
    def _change_response_type(self, response) -> None:
        ...
        if response.message == 'recognizer':
